...
class Computer1CORezPage extends StatelessWidget {
  Computer1CORezPage(this.date);

  Computer1COController _controller = Get.find<Computer1COController>();
  DateTime date;
      ...
      body: Column(
        children: [
          ...
          FieldRezHeader(
            today: date,
            facility: Facility(
              icon: personalFacility[0].company![0].icon,
              name: personalFacility[0].company![0].name,
              intro: personalFacility[0].company![0].intro,
            )
          ),
          _gridViewHeader(),
          Expanded(
                  ...
                  return Obx(() {
                    ...
                    _controller.endAbsTime.value != null) {
                      ...
                      if(state == RezState.ABLE) {
                        int cnt = _controller.computer1COField.value.rezs!.length;
                        for(int i=0; i<cnt; i++){
                          ComputerRez rz = _controller.computer1COField.value.rezs![i];
            ...
            CustromElevatedButton(
              ...
              onPressed: () {
                ...
                CoolAlert.show(
                  ...
                  title: "${personalFacility[0].company![0].name}",
