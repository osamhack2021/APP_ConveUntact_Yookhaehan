...
class Computer2COController extends GetxController {
  Rx<ComputerField> computer2COField = Rx(ComputerField());
  RxList<ComputerField> computer2COFieldList = RxList();
