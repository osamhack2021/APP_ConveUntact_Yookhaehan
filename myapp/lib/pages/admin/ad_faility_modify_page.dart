    ...
    return DraggableHome(
      ...
      body: [
        ...
        Row(
          ...
          children: [
            Padding(padding: EdgeInsets.all(10)),
            Text("개인시설 목록", style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold, fontSize: 20)),
            Spacer(),
            Text("${personalFacilityList.length}개의 시설 존재", style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold, fontSize: 10)),
            SizedBox(width: 6),
          ]
        ),
        Divider(),
