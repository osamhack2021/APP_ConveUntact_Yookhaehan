...
class Karaoke1COController extends GetxController {
  Rx<KaraokeField> karaoke1COField = Rx(KaraokeField());
  RxList<KaraokeField> karaoke1COFieldList = RxList();
