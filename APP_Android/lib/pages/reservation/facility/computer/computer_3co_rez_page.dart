...
class Computer3CORezPage extends StatelessWidget {
  Computer3CORezPage(this.date);

  Computer3COController _controller = Get.find<Computer3COController>();
  DateTime date;
      ...
      body: Column(
        children: [
          ...
          FieldRezHeader(
            today: date,
            facility: Facility(
              icon: personalFacility[0].company![2].icon,
              name: personalFacility[0].company![2].name,
              intro: personalFacility[0].company![2].intro,
            )
          ),
          _gridViewHeader(),
          Expanded(
                  ...
                  return Obx(() {
                    ...
                    _controller.endAbsTime.value != null) {
                      ...
                      if(state == RezState.ABLE) {
                        int cnt = _controller.computer3COField.value.rezs!.length;
                        for(int i=0; i<cnt; i++){
                          ComputerRez rz = _controller.computer3COField.value.rezs![i];
            ...
            CustromElevatedButton(
              ...
              onPressed: () {
                ...
                CoolAlert.show(
                  ...
                  title: "${personalFacility[0].company![2].name}",
