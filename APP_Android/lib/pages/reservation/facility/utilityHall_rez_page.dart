...
class UtilityHallRezPage extends StatelessWidget {
  UtilityHallRezPage(this.date);

  UtilityHallController _controller = Get.find<UtilityHallController>();
  DateTime date;
      ...
      body: Column(
        children: [
          ...
          FieldRezHeader(
            today: date,
            facility: Facility(
              icon: teamFacility[5].icon,
              name: teamFacility[5].name,
              intro: teamFacility[5].intro,
            )),
          _gridViewHeader(),
          Expanded(
                  ...
                  return Obx(() {
                    ...
                    _controller.endAbsTime.value != null) {
                      ...
                      if(state == RezState.ABLE) {
                        int cnt = _controller.utilityHall.value.rezs!.length;
                        for(int i=0; i<cnt; i++){
                          UtilityHallRez rz = _controller.utilityHall.value.rezs![i];
