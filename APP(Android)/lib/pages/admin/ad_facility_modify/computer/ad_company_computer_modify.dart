...
class ADCompanyComputerModifyScreen extends StatefulWidget {
  @override
  _ADCompanyComputerModifyScreenState createState() => _ADCompanyComputerModifyScreenState();
}

class _ADCompanyComputerModifyScreenState extends State<ADCompanyComputerModifyScreen> {
  String input = "";
  ...
  ListView listView() {
    return ListView.builder(
      ...
      itemCount: personalFacility[0].company!.length,
      shrinkWrap: true,
      itemBuilder: (context, index) => Card(
        ...
        child: ListTile(
          ...
          //),
          title: Text("${personalFacility[0].company![index].name}", style: TextStyle(color: Colors.indigo.shade200, fontWeight: FontWeight.bold)),
          trailing: Row(
            mainAxisSize: MainAxisSize.min,
            children: <Widget>[
              IconButton(
                ...
                onPressed: (){
                  CoolAlert.show(
                    ...
                    title: "${personalFacility[0].company![index].name}",
              ...
              IconButton(
                ...
                onPressed: (){
                  ...
                  setState(() {
                    personalFacility[0].company!.removeAt(index);
                  });
                }),
            ]
          )
