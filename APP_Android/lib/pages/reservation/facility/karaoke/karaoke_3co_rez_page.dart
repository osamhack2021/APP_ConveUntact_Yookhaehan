...
class Karaoke3CORezPage extends StatelessWidget {
  Karaoke3CORezPage(this.date);

  Karaoke3COController _controller = Get.find<Karaoke3COController>();
  DateTime date;
                  ...
                  return Obx(() {
                    ...
                    _controller.endAbsTime.value != null) {
                      ...
                      if(state == RezState.ABLE) {
                        int cnt = _controller.karaoke3COField.value.rezs!.length;
                        for(int i=0; i<cnt; i++){
                          KaraokeRez rz = _controller.karaoke3COField.value.rezs![i];
