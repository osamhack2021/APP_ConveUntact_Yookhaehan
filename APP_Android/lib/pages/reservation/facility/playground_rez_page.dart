...
class PlaygroundRezPage extends StatelessWidget {
  PlaygroundRezPage(this.date);

  PlaygroundController _controller = Get.find<PlaygroundController>();
  DateTime date;
      ...
      body: Column(
        children: [
          ...
          FieldRezHeader(
            today: date,
            facility: Facility(
              icon: teamFacility[3].icon,
              name: teamFacility[3].name,
              intro: teamFacility[3].intro,
            )
          ),
          _gridViewHeader(),
          Expanded(
                  ...
                  return Obx(() {
                    ...
                    _controller.endAbsTime.value != null) {
                      ...
                      if(state == RezState.ABLE) {
                        int cnt = _controller.playground.value.rezs!.length;
                        for(int i=0; i<cnt; i++){
                          PlaygroundRez rz = _controller.playground.value.rezs![i];
