...
class Karaoke1CORezPage extends StatelessWidget {
  Karaoke1CORezPage(this.date);

  Karaoke1COController _controller = Get.find<Karaoke1COController>();
  DateTime date;
                  ...
                  return Obx(() {
                    ...
                    _controller.endAbsTime.value != null) {
                      ...
                      if(state == RezState.ABLE) {
                        int cnt = _controller.karaoke1COField.value.rezs!.length;
                        for(int i=0; i<cnt; i++){
                          KaraokeRez rz = _controller.karaoke1COField.value.rezs![i];
