...
class Computer2CORezPage extends StatelessWidget {
  Computer2CORezPage(this.date);

  Computer2COController _controller = Get.find<Computer2COController>();
  DateTime date;
      ...
      body: Column(
        children: [
          ...
          FieldRezHeader(
            today: date,
            facility: Facility(
              icon: personalFacility[0].company![1].icon,
              name: personalFacility[0].company![1].name,
              intro: personalFacility[0].company![1].intro,
            )
          ),
          _gridViewHeader(),
          Expanded(
                  ...
                  return Obx(() {
                    ...
                    _controller.endAbsTime.value != null) {
                      ...
                      if(state == RezState.ABLE) {
                        int cnt = _controller.computer2COField.value.rezs!.length;
                        for(int i=0; i<cnt; i++){
                          ComputerRez rz = _controller.computer2COField.value.rezs![i];
            ...
            CustromElevatedButton(
              ...
              onPressed: () {
                ...
                CoolAlert.show(
                  ...
                  title: "${personalFacility[0].company![1].name}",
